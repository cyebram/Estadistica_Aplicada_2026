...
Si $Z_1, Z_2, \ldots, Z_n$ son variables aleatorias independientes e idénticamente distribuidas con distribución normal estándar $N(0,1)$, entonces:
...
p_casos_moda <- ggplot() +
  ...
  labs(
    title = "Localización de las modas",
