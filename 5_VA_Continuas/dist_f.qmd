...
p1 <- ggplot(df1, aes(x = x, y = y, color = Parametros)) +
  ...
  labs(title = "Variando grados de libertad del numerador (a)",
       ...
       x = "x", y = "f(x)") +
  scale_color_manual(values = c("F(2, 10)" = "steelblue", "F(5, 10)" = "darkorange", 
                                        "F(10, 10)" = "forestgreen", "F(20, 10)" = "purple")) +
  theme_minimal() +
...
p2 <- ggplot(df2, aes(x = x, y = y, color = Parametros)) +
  ...
  labs(title = "Variando grados de libertad del denominador (b)",
       ...
       x = "x", y = "f(x)") +
  scale_color_manual(values = c("F(5, 5)" = "steelblue", "F(5, 10)" = "darkorange", 
                                        "F(5, 20)" = "forestgreen", "F(5, 50)" = "purple")) +
  theme_minimal() +
  theme(legend.position = "bottom")
...
p3 <- ggplot(df3, aes(x = x, y = y, color = Parametros)) +
  ...
  labs(title = "Variando ambos grados de libertad simultáneamente",
       subtitle = "a = b",
       x = "x", y = "f(x)") +
  scale_color_manual(values = c("F(2, 2)" = "steelblue", "F(5, 5)" = "darkorange", 
                                        "F(10, 10)" = "forestgreen", "F(30, 30)" = "purple")) +
  theme_minimal() +
  theme(legend.position = "bottom")
...
p4 <- ggplot(df4, aes(x = x, y = y, color = Parametros, linetype = Parametros)) +
  ...
  labs(title = "Asimetría en el intercambio de parámetros",
       ...
       x = "x", y = "f(x)") +
  scale_color_manual(values = c("F(5, 10)" = "steelblue", "F(10, 5)" = "darkorange")) +
  theme_minimal() +
  theme(legend.position = "bottom")
...
\begin{equation}
F(x)= P(X\leq x) = 
\int_0^x\frac{\Gamma\left(\frac{a+b}{2}\right)}{\Gamma\left(\frac{a}{2}\right)\Gamma\left(\frac{b}{2}\right)} \left(\frac{a}{b}\right)^{a/2} u^{a/2-1} \left(1 + \frac{a}{b}u\right)^{-(a+b)/2} du
\end{equation}
